...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    股东 <i class="fa fa-user"></i><small>${userSession.role_name}-
                    ${userSession.user_name} </small>
                </h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form method="post" action="${pageContext.request.contextPath }/csrht/shareholder">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">股东名称</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <li>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">股份类型</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="share_type" type="text" class="form-control col-md-7 col-xs-12"
                                           value="${share_type}">
                                </div>
                            </div>
                        </li>
        ...
        <div class="x_panel">
            <div class="x_content">
                ...
                <div id="datatable-responsive_wrapper"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="javascript:;" id="addshareholder" class="btn btn-success btn-sm">新增股东信息</a>
                            <table id="datatable-responsive"
                                ...
                                <c:forEach var="pages" items="${page.content}" varStatus="status">
                                    <tr role="row" class="odd">
                                        ...
                                        <td>${pages.shareholder_name}</td>
                                        <td>${pages.share_type}</td>
                                        <td>${pages.number_of_shares}</td>
                                        <td>${pages.proportion}</td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a class="modifyAppInfo1" data-toggle="tooltip"
                                                           ...
                                                           data-original-title="修改股东信息" id="updateshareholder" shareholderid="${pages.id}">修改</a></li>
                                                    <li><a class="modifyAppInfo" data-toggle="tooltip"
                                                           data-placement="top" title=""
                                                           data-original-title="删除股东信息" deleteshareholderid="${pages.id}">删除</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
    ...
    $(function () {
        ...
        $('#addshareholder').on('click', function () {
            layer.open({
                ...
                area: ['600px', '500px'],
                content: '${pageContext.request.contextPath }/web/addshareholder.html',
                end: function () {
                    location.reload();
                }
            });
        ...
        //修改弹出层
        $('#updateshareholder ').on('click', function () {
            var obj=$(this);
            console.log(obj.attr('shareholderid'))
            layer.open({
                type: 2,
                title: '修改股东信息',
                maxmin: true,
                ...
                anim:1,
                area: ['600px', '500px'],
                content: '${pageContext.request.contextPath }/web/updateshareholder.html?id='+obj.attr("shareholderid"),
                end: function () {
                    location.reload();
                }
            });
        ...
        $('.modifyAppInfo').on('click',function () {
            var obj=$(this);
            console.log(obj.attr('deleteshareholderid'))
            parent.layer.confirm("确定要删除这条记录吗？",{btn:['确定','取消']},function (confirm) {
                layer.close(confirm);
                $.ajax({
                    type:"post",
                    url:"/shareholder/deleteshareholder/"+obj.attr("deleteshareholderid"),
                    dataType:"json",
