...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    前五大供应商信息管理维护 <i class="fa fa-user"></i><small>${userSession.role_name}-
                    ${userSession.user_name} - 您可以通过搜索或者其他的筛选项对前五大供应商信息进行修改、删除等管理操作。</small>
                </h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form method="post" action="${pageContext.request.contextPath }/csrht/fiveSuppler">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="supplier_name" type="text" class="form-control col-md-7 col-xs-12"
                                           value="${name}">
                                </div>
                            </div>
                        </li>
        ...
        <div class="x_panel">
            <div class="x_content">
                ...
                <div id="datatable-responsive_wrapper"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="javascript:;" class="btn btn-success btn-sm" id="addfive">新增供应商信息</a>
                            <table id="datatable-responsive"
                                ...
                                <c:forEach var="pages" items="${page.content}" varStatus="status">
                                    <tr role="row" class="odd">
                                        <td tabindex="0" class="sorting_1">${pages.supplier_name}</td>
                                        <td>${pages.announcement_date}</td>
                                        <td>${pages.amt}</td>
                                        <td>${pages.alias}</td>
                                        <td>${pages.relationship}</td>
                                        <td>${pages.dataSource}</td>
                                        <td>${pages.ratio}</td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a class="updatefive" data-toggle="tooltip"
                                                           data-placement="top" title="" updateid="${pages.id}"
                                                           data-original-title="修改公司信息">修改</a></li>
                                                    <li><a class="deletefive" data-toggle="tooltip"
...
<script type="text/javascript">
    ...
    $(".updatefive").on('click',function () {
        ...
        layer.open({
            ...
            shade:[0.8,'#393D49'],
            area:['800px','600px'],
            content: '/web/updatefive.html?id='+obj.attr('updateid'),
            end:function () {
                location.reload();
            }
        })
    ...
    $(".deletefive").on('click',function () {
        ...
        parent.layer.confirm("确定要删除这条记录吗？",{btn:['确定','取消']},function (confirm) {
            ...
            $.ajax({
                type:"POST",
                url:"/Five/deleteFive/"+obj.attr("deleteid"),
                dataType:"json",
