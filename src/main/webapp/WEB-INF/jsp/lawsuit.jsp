...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    法律诉讼信息管理维护 <i class="fa fa-user"></i><small>${userSession.role_name}-
                    ${userSession.user_name} - 您可以通过搜索或者其他的筛选项对法律诉讼的信息进行修改、删除等管理操作。</small>
                </h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form method="post" action="${pageContext.request.contextPath }/csrht/lawsuit">
        ...
        <div class="x_panel">
            <div class="x_content">
                ...
                <div id="datatable-responsive_wrapper"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="${pageContext.request.contextPath}/" class="btn btn-success btn-sm">新增法律诉讼信息</a>
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <c:forEach var="pages" items="${page.content}" varStatus="status">
                                        <tr role="row" class="odd">
                                            ...
                                            <td>${pages.plaintiffs}</td>
                                            <td>${pages.court}</td>
                                            <td>${pages.casereason}</td>
                                            <td>${pages.url}</td>
                                            <td>${pages.caseno}</td>
                                            <td>${pages.title}</td>
                                            <td>${pages.abstracts}</td>
                                            <td><fmt:formatDate value="${pages.submittime}" type="date"/></td>
                                            <td>${pages.lawsuitUrl}</td>
                                            <td>${pages.casetype}</td>
                                            <td>${pages.doctype}</td>
                                            <td>${pages.agent}</td>
                                            <td>${pages.thirdParties}</td>
                                            <td>${pages.defendants}</td>
                                            <td>
                                                <div class="btn-group">
