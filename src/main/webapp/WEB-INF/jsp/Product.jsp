...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    产品信息管理维护 <i class="fa fa-user"></i><small>${userSession.role_name}-
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <c:forEach var="pages" items="${page.content}" varStatus="status">
                                        <tr role="row" class="odd">
                                            ...
                                            <td tabindex="0" class="sorting_1">${pages.product_name}</td>
                                            <td>${pages.patent_t_name}</td>
                                            <td>${pages.product_territory}</td>
                                            <c:if test="${pages.study_appear==1}">
                                            <td>在研</td>
                                            </c:if>
                                            <c:if test="${pages.study_appear==2}">
                                            <td>上市</td>
                                            </c:if>
                                            <td>${pages.registered}</td>
                                            <td>${pages.stage_name}</td>
                                            <td>${pages.company_name}</td>
                                            <td>${pages.patent_no}</td>
                                            <td>${pages.patent_t_name}</td>
                                            <td>${pages.approvals_no}</td>
                                            <c:if test="${pages.domestic_import==1}">
                                            <td>国产</td>
                                            </c:if>
                                            <c:if test="${pages.domestic_import==2}">
                                            <td>进口</td>
                                            </c:if>
                                            <td>${pages.yieldly}</td>
