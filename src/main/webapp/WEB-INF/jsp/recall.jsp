...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    产品召回 <i class="fa fa-user"></i><small>${userSession.role_name}-
        ...
        <div class="x_panel">
            <div class="x_content">
                ...
                <div id="datatable-responsive_wrapper"
                    ...
                    <div class="row">
                        <button type="submit" id="addrecall" class="btn btn-primary"> 新增产品召回</button>
                        <div class="col-sm-12">
    ...
    $(function () {
        ...
        $(".update").click(function () {
            ...
            layer.open({
                ...
                area: ['893px', '700px'],
                anim: 2,
                content: '/recall/updaterecall/'+obj.attr("common"),
                end: function () {
                    location.reload();
                }
            });
        ...
        $(".delete").click(function () {
            ...
            layer.confirm('您确认删除吗？', {
                ...
                $.ajax({
                    type: "POST",
                    url: "/recall/deleterecall/"+obj.attr("common"),
                    dataType: 'json',
