...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form method="post" action="${pageContext.request.contextPath }/csrht/clinic">
                    <input type="hidden" name="pageNum" value="1" />
                    <ul>
                        <li>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">药品名称</label>
        ...
        <div class="x_panel">
            <div class="x_content">
                ...
                <div id="datatable-responsive_wrapper"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="javascript:;" id="addclinic" class="btn btn-success btn-sm">新增临床信息</a>
                            <table id="datatable-responsive"
                                ...
                                <c:forEach var="pages" items="${page.content}" varStatus="status">
                                    <tr role="row" class="odd">
                                        ...
                                        <td>${pages.record_number}</td>
                                        <td>${pages.adaptation_disease}</td>
                                        <td><fmt:formatDate value="${pages.record_date}" type="date"/></td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a class="modifyAppInfo1" data-toggle="tooltip"
                                                           ...
                                                           data-original-title="修改临床信息" id="updateclinic" clinicid="${pages.id}">修改</a></li>
                                                    <li><a class="modifyAppInfo" data-toggle="tooltip"
                                                           data-placement="top" title=""
                                                           data-original-title="删除临床信息" deleteclinicid="${pages.id}">删除</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
    ...
    $(function () {
        ...
        $('#addclinic').on('click', function () {
            ...
            layer.open({
                ...
                area: ['600px', '500px'],
                content: '${pageContext.request.contextPath }/web/addclinic.html',
                end: function () {
                    location.reload();
                }
            });
        ...
        $('#updateclinic ').on('click', function () {
            ...
            layer.open({
                ...
                anim:1,
                area: ['600px', '500px'],
                content: '${pageContext.request.contextPath }/web/updateclinic.html?id='+obj.attr("clinicid"),
                end: function () {
                    location.reload();
                }
            });
        ...
        $('.modifyAppInfo').on('click',function () {
            var obj=$(this);
            console.log(obj.attr('deleteclinicid'))
