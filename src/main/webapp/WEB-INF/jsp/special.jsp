...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    企业特别公告 <i class="fa fa-user"></i><small>${userSession.role_name}-
                    ${userSession.user_name} </small>
                </h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form method="post" action="${pageContext.request.contextPath }/csrht/special">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="release_time" type="date" class="form-control col-md-7 col-xs-12"
                                           value="${release_time}">
                                </div>
                            </div>
                        </li>
        ...
        <div class="x_panel">
            <div class="x_content">
                ...
                <div id="datatable-responsive_wrapper"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="javascript:;" id="addspecialb" class="btn btn-success btn-sm">新增企业特别公告信息</a>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a class="modifyAppInfo1" data-toggle="tooltip"
                                                           ...
                                                           data-original-title="修改特别公告信息" id="updatespecial" specialid="${pages.id}">修改</a></li>
                                                    <li><a class="modifyAppInfo" data-toggle="tooltip"
                                                           data-placement="top" title=""
                                                           data-original-title="删除特别公告信息" deletespecialid="${pages.id}">删除</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
    ...
    $(function () {
        ...
        $('#addspecialb').on('click', function () {
            layer.open({
                ...
                area: ['600px', '500px'],
                content: '${pageContext.request.contextPath }/web/addspecialb.html',
                end: function () {
                    location.reload();
                }
            });
        ...
        $('#updatespecial ').on('click', function () {
            ...
            layer.open({
                ...
                anim:1,
                area: ['600px', '500px'],
                content: '${pageContext.request.contextPath }/web/updatespecial.html?id='+obj.attr("specialid"),
                end: function () {
                    location.reload();
                }
            });
        ...
        $('.modifyAppInfo').on('click',function () {
            var obj=$(this);
            console.log(obj.attr('deletespecialid'))
            parent.layer.confirm("确定要删除这条记录吗？",{btn:['确定','取消']},function (confirm) {
                layer.close(confirm);
                $.ajax({
                    type:"post",
                    url:"/specialb/deletespeciall/"+obj.attr("deletespecialid"),
                    dataType:"json",
