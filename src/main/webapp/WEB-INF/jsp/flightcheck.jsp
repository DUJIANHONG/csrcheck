...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    飞行检查 <i class="fa fa-user"></i><small>${userSession.role_name}-
                    ${userSession.user_name} </small>
                </h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form method="post" action="${pageContext.request.contextPath }/csrht/flightcheck">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">检查编号</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="check_no" type="text" class="form-control col-md-7 col-xs-12"
                                           value="${check_no}">
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">公布日期</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="publication" type="date" class="form-control col-md-7 col-xs-12"
                                           value="${publication}">
                                </div>
                            </div>
                        </li>
                            ...
                            <table id="datatable-responsive"
                                ...
                                <c:forEach var="pages" items="${page.content}" varStatus="status">
                                    <tr role="row" class="odd">
                                        <td tabindex="0" class="sorting_1">${pages.check_no}</td>
                                        <td>${pages.product_name}</td>
                                        <td>${pages.product_t_name}</td>
                                        <td>${pages.punish}</td>
                                        <td>${pages.attention}</td>
                                        <td><fmt:formatDate value="${pages.publication}" type="date"></fmt:formatDate></td>
                                        <td><fmt:formatDate value="${pages.term_of_validity}" type="date"></fmt:formatDate></td>
                                        <td>${pages.content}</td>
